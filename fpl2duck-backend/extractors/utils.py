...
def dump_model_to_parquet(model: Bootstrap | ElementSummary | Fixtures, path: str) -> None:
...
def pydantic_records_to_arrow_table(records: list[Bootstrap | ElementSummary | Fixtures]) -> pa.Table:
